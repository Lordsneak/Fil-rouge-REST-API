...
public class AdvertServiceImpl implements AdvertService{
	...
	@Override
	public AdvertDto getAdvert(String titleAdvert) {
		
		AdvertEntity advertEntity = advertRepository.findByTitleAdvert(titleAdvert);

		if (advertEntity == null)
			throw new UsernameNotFoundException(titleAdvert);
	...
	@Override
	public AdvertDto getAdvertByPrice(String priceAdvert) {
		
		AdvertEntity advertEntity = advertRepository.findByPriceAdvert(priceAdvert);

		if (advertEntity == null)
			throw new UsernameNotFoundException(priceAdvert);
	...
	public AdvertDto updateAdvert(String advertId, AdvertDto advertDto) {
		...
		advertEntity.setTitleAdvert(advertDto.getTitleAdvert());
		advertEntity.setDescriptionAdvert(advertDto.getDescriptionAdvert());
		advertEntity.setPriceAdvert(advertDto.getPriceAdvert());
		advertEntity.setImageAdvert(advertDto.getImageAdvert());
