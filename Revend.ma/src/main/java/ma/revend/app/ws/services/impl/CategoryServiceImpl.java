...
public class CategoryServiceImpl implements CategoryService{
	...
	public CategoryDto getCategory(String nameCategory) {
		...
		CategoryEntity categoryEntity = categoryRepository.findByNameCategory(nameCategory);

		if (categoryEntity == null)
			throw new UsernameNotFoundException(nameCategory);
	...
	public CategoryDto updateCategory(String categoryId, CategoryDto categoryDto) {
		...
		categoryEntity.setLogoCategory(categoryDto.getLogoCategory());
		categoryEntity.setDescriptionCategory(categoryDto.getDescriptionCategory());
	...
	public CategoryDto createCategory(CategoryDto category) {
		...
		CategoryEntity checkprod = categoryRepository.findByNameCategory(category.getNameCategory());
